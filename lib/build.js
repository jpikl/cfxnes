...
const compiler = new Compiler({
  ...
  process_common_js_modules: true, // Only because of reexport core/index.js
  dependency_mode: 'NONE', // STRICT is currently bugged
  ...
  externs: 'externs.js',
  jscomp_off: [
    'checkTypes', // TODO fix compiler warnings
    'checkVars', // Module resolution is currently bugged it prints warnings for when using export {default as name}
  ],
