import {formatSize, toString} from '../../../core/src/common/utils';
...
export default class ROM {
  ...
  load(source) {
    ...
    throw new Error('Invalid source: ' + toString(source));
  }
  ...
  unzipData(data) {
    if (hasZipSignature(data)) {
      ...
      if (JSZip == null || JSZip.loadAsync == null) {
        throw new Error('Unable to extract ROM image: JSZip 3.x.x is not available');
      }
