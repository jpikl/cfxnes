...
export default class CFxNES {
  ...
  ['setInputDevice'](port, id) {
    this.inputModule.getDevice(port, id);
  }
  ...
  ['mapInput'](deviceInput, sourceInputs) {
    this.inputModule.mapInput(deviceInput, sourceInputs);
  }

  ['unmapInput'](input) {
    this.inputModule.unmapInput(input);
  }

  ['unmapAllInputs']() {
    return this.inputModule.unmapAllInputs();
  }
