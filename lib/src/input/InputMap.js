import {log, describeValue} from '../../../core';
...
export default class InputMap {
  ...
  setAll(mapping) {
    if (!mapping || typeof mapping !== 'object') {
      throw new Error('Invalid mapping: ' + describeValue(mapping));
    }
    ...
    for (const devInputStr in mapping) {
      ...
      if (typeof srcInputValue === 'string') {
        ...
        throw new Error('Invalid source input(s): ' + describeValue(srcInputValue));
      }
    }
  }
