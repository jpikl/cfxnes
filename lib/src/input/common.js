...
export const sources = {
  'keyboard': {SourceClass: Keyboard, indexed: false},
  'mouse': {SourceClass: Mouse, indexed: false},
  'gamepad': {SourceClass: Gamepad, indexed: true},
};

export const devices = {
  'joypad': {DeviceClass: Joypad, AdapterClass: JoypadAdapter},
  'zapper': {DeviceClass: Zapper, AdapterClass: ZapperAdapter},
};
