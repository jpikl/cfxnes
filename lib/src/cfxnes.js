...
function cfxnes(initOptions = {}) {
  assert(initOptions && typeof initOptions === 'object');
  ...
  const instance = defineProperties({}, {
    ...
    'inputs': build.nested({
      'set': build.method(inputs.set, inputs),
      'get': build.method(inputs.get, inputs),
      'delete': build.method(inputs.delete, inputs),
