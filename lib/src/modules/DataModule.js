...
import {formatSize, logger} from '../../../core/src/utils';
...
export default class DataModule {
  ...
  constructor() {
    this.dependencies = ['nes', 'systemModule', 'videoModule', 'audioModule', 'inputModule', 'JSZip', 'sha1'];
  }

  inject(nes, systemModule, videoModule, audioModule, inputModule, JSZip, sha1) {
    this.nes = nes;
    this.systemModule = systemModule;
    this.modules = [systemModule, videoModule, audioModule, inputModule];
    this.libs = {JSZip, sha1};
  }
  ...
  loadROMFromArray(array) {
    ...
    return new Promise(resolve => {
      const cartridge = createCartridge(array, this.libs);
