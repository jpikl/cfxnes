...
describe('input/sources/Mouse', () => {
  ...
  it('should generate input for button press when activated', () => {
    dispatchEvent(new MouseEvent('mousedown'));
    expect(router.input).to.be.an('object');
  });

  it('should generate input for button release when activated', () => {
    dispatchEvent(new MouseEvent('mouseup'));
    expect(router.input).to.be.an('object');
  });

  it('should generate input for mouse movement when activated', () => {
    dispatchEvent(new MouseEvent('mousemove'));
    expect(router.input).to.be.an('object');
  });

  it('should not generate input for button press when deactivated', () => {
    source.deactivate();
    dispatchEvent(new MouseEvent('mousedown'));
    expect(router.input).to.be.undefined;
  });

  it('should not generate input for button release when deactivated', () => {
    source.deactivate();
    dispatchEvent(new MouseEvent('mouseup'));
    expect(router.input).to.be.undefined;
  });

  it('should not generate input for mouse movement when deactivated', () => {
    source.deactivate();
    dispatchEvent(new MouseEvent('mousemove'));
    expect(router.input).to.be.undefined;
  });

  it('should generate valid input for button press', () => {
  ...
  it('should generate valid input for button release', () => {
  ...
  it('should generate valid input for mouse movement', () => {
