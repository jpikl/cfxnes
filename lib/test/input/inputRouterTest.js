import {Nes, JoypadButton} from '../../../core';
...
describe('input/InputRouter', () => {
  ...
  it('does not route unmapped input', () => {
    ...
    expect(nes.getInputDevice(1).isButtonPressed(JoypadButton.A)).to.be.false;
  });
  ...
  it('routes mapped input', () => {
    ...
    expect(nes.getInputDevice(1).isButtonPressed(JoypadButton.A)).to.be.true;
  });
