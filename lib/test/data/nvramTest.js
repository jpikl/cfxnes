...
describe('data/NVRAM (cartridge with NVRAM set)', () => {
  ...
  beforeEach(() => {
    ...
    return new Promise((resolve, reject) => {
      setTimeout(() => {
        deleteDB().then(resolve, reject);
      }, 1000); // Some browsers need a little delay before closing and deleting DB
    });
  });
  ...
  it('provides the same object every time', () => {
