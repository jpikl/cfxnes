...
class DebugCPU extends CPU
    ...
    readOperation: ->
        ...
        @instructionByte1 = @memory.read @programCounter
        @instructionByte2 = @memory.read (@programCounter + 1) & 0xFFFF
        @instructionByte3 = @memory.read (@programCounter + 2) & 0xFFFF
        super()
